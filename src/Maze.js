...
const Maze = () => {
    ...
    <Router>
      <nav className="navbar">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <Link className="react-link" to="/recursive-backtracker">
              <a href="#" className="nav-link" >
          ...
          <li className="nav-item">
            <Link className="react-link" to="/aldous-broder">
              <a href="#" className="nav-link" >
      ...
      <Switch>
        ...
        <Route path="/recursive-backtracker" exact component={RecursiveBacktracker} />
        <Route path="/aldous-broder" exact component={AldousBroder} />
      </Switch>
